...
const AnimatedStatsWithDividers = () => {
  ...
  const MobileStatItem = ({ stat, index, isLast }) => {
    ...
    return (
      ...
      >
        {/* Large Number with Animation */}
        <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 font-mono text-center leading-none mb-2">
          {stat.prefix && stat.prefix}
          {formatNumber(count)}
          {stat.suffix && stat.suffix}
        </div>
  ...
  return (
    <>
      <div ref={sectionRef} className="w-full bg-[#FFFF] py-2 md:py-10 px-4">
        <div className="max-w-[1920px] ml-6 mr-6 md:ml-10 md:mr-10 mx-auto">
...
export default AnimatedStatsWithDividers;
